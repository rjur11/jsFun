...
const kittyPrompts = {
  orangeKittyNames() {
    ...
    /*
      ...
      want to get back an array of only orange colored kitties names
      use a filter method to get back orange cats array
      only want names of orange cats- use map
    */
  },
...
const clubPrompts = {
  membersBelongingToClubs() {
    ...
    //   ...etc
    // }
    const result = clubs.reduce((acc, { club, members }) => {
